...
<div class="d-flex">
  ...
  <div class="card card-primary cennter  m-3  col-8">
    ...
    <form action="{{route('images.update', $imags->id)}}" method="POST" enctype="multipart/form-data">
      @method('put')
      @csrf
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="status" id="">
            ...
            <option value="0" {{$imags->status==0?"selected":""}}>Nofaol</option>
          </select>
        </div>
      </div>
