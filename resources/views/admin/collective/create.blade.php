...
<div class="d-flex">
  ...
  <div class="card card-primary cennter  m-3  col-8">
    <div class="card-header">
      <h3 class="card-title">Yangi ishchi qoshish</h3>
    </div>
    <form action="{{route('collective.store')}}" method="POST" enctype="multipart/form-data">
      {{-- @method('put') --}}
      @csrf
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">Name</label>
          <input type="text" name="titles" class="form-control" placeholder="Titles" {{ old('titles')}}>
